...
| Platform | File |
|---|---|
| 🪟 Windows | [Mock Test Tracker Setup 2.0.0.exe](https://github.com/sanjayk29/exam-tracker/releases/latest/download/Mock.Test.Tracker.Setup.2.0.0.exe) |
| 🍎 macOS | [Mock Test Tracker-2.0.0-arm64.dmg](https://github.com/sanjayk29/exam-tracker/releases/latest/download/Mock.Test.Tracker-2.0.0-arm64.dmg) |
